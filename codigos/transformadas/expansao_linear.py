...
imagem_expandida = np.array(imagem_expandida, dtype=np.uint8)


caminho_imagem_expandida = 'C:\\Users\\Cliente\\OneDrive\\Documentos\\PIBIC\\processamentoImagens_Codigos\\teste\\imagem_expandidaC.jpg'
